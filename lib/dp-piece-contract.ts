...
export const DP_PIECE_CONTRACTS: readonly DpPieceContract[] = [
  ...
  },
  {
    ...
    shortTitle: "Masse",
    purpose: "Présenter la vraie parcelle et la vraie construction depuis l'imagerie IGN, puis faire représenter le projet photovoltaïque sans autoriser l'IA à changer la propriété.",
  ...
  },
  {
    ...
    shortTitle: "Coupe",
    purpose: "Produire une coupe architecturale du vrai bâtiment avec ChatGPT Image, contrôlée par les faits métriques disponibles et sans inventer de cote. Le pan est compris depuis les photos, sans sélection satellite utilisateur.",
    fields: ["address", "moduleReference", "panelCount", "rows", "columns", "orientation", "placement", "gutterClearanceMm", "interPanelGapMm", "nearPhoto", "roofPhoto"],
    output: "image",
    usesSiteTwin: true,
    usesLayout: true,
    usesCameraRegistration: false,
  ...
  },
  {
    ...
    purpose: "Présenter l'état initial et l'état futur depuis une vraie photographie. ChatGPT Image identifie directement le pan visible et ses obstacles ; aucune sélection satellite n'est utilisée pour l'insertion.",
    fields: ["address", "moduleReference", "panelCount", "rows", "columns", "orientation", "placement", "gutterClearanceMm", "interPanelGapMm", "nearPhoto", "roofPhoto"],
    output: "image",
    usesSiteTwin: true,
    usesLayout: true,
  ...
  },
  {
    ...
    purpose: "Montrer précisément l'aspect extérieur final depuis une vraie photographie. ChatGPT Image comprend directement le toit, les Velux, cheminées et limites visibles.",
    fields: ["address", "moduleReference", "panelCount", "rows", "columns", "orientation", "placement", "gutterClearanceMm", "interPanelGapMm", "roofPhoto", "nearPhoto"],
    output: "image",
    usesSiteTwin: true,
    usesLayout: true,
    usesCameraRegistration: true,
  ...
  },
  {
    ...
    purpose: "Montrer le projet depuis une photographie contextualisée, avec compréhension directe du toit par ChatGPT Image et contrôle indépendant après génération. Aucun choix de pan satellite n'est transmis à l'édition photo.",
    fields: ["address", "moduleReference", "panelCount", "rows", "columns", "orientation", "placement", "gutterClearanceMm", "interPanelGapMm", "farPhoto", "nearPhoto", "roofPhoto"],
    output: "image",
    usesSiteTwin: true,
    usesLayout: true,
    usesCameraRegistration: true,
