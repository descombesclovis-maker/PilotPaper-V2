...
export const DP_PIECE_CONTRACTS: readonly DpPieceContract[] = [
  ...
  },
  {
    ...
    fields: ["address", "moduleReference", "panelCount", "rows", "columns", "orientation", "nearPhoto"],
    output: "image",
    usesSiteTwin: false,
    usesLayout: false,
    usesCameraRegistration: false,
  ...
  },
  {
    ...
    fields: ["address", "moduleReference", "panelCount", "rows", "columns", "orientation", "farPhoto"],
    output: "image",
    usesSiteTwin: false,
    usesLayout: false,
    usesCameraRegistration: false,
